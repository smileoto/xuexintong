						...
						<div class="content-inner">
							...
							<ul>
								<li style="width:100%">
									...
									<input type="text" style="width: 477px;" name="username" id="username" />
								</li>
								<li style="width:100%">
									<span class="m-name">
										名称：
									</span>
									<input type="text" style="width: 477px;" name="realname" id="realname" />
								</li>
								<li style="width:100%">
									<span class="m-name">
										说明：
									</span>
									<input type="text" style="width: 477px;" name="remark" id="remark" />
								</li>
