						...
						<div class="accountSettings-box">
							<ul>
								<li style="width:100%">
									...
									<input type="text" style="width: 477px;" class="data-field" id="username" value="<?php echo $user['username']?>" disabled="disabled" />
								</li>
								<li style="width:100%">
									<span class="m-name">
										名称：
									</span>
									<input type="text" style="width: 477px;" class="data-field" id="realname" value="<?php echo $user['realname']?>" />
								</li>
								<li style="width:100%">
									<span class="m-name">
										说明：
									</span>
									<input type="text" style="width: 477px;" class="data-field" id="remark" value="<?php echo $user['remark']?>" />
								</li>
...
<script type="text/javascript" charset="utf-8">
$(function(){
	var jsonStr = '<?php echo $user_groups?>';
